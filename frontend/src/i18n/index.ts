...
const zh: Record<string, string> = {
  ...
  // Prompt library
  'prompt.libraryDescription': '保存和复用可复用的文本提示词模板。',
  ...
  'prompt.formatInstruction': '格式指令',
  'prompt.notes': '备注',
  'prompt.save': '保存',
  'prompt.saveNewVersion': '保存为新版本',
...
const en: Record<string, string> = {
  ...
  // Prompt library
  'prompt.libraryDescription': 'Save and reuse reusable text prompt templates.',
  ...
  'prompt.notes': 'Notes',
  'prompt.save': 'Save',
  'prompt.saveNewVersion': 'Save as new version',
